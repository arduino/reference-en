...
[NOTE]
====
This repository is no longer actively maintained. The Arduino Language Reference has moved to the https://github.com/arduino/docs-content-reference[`docs-content-reference`] repository.

The content is now rendered at https://docs.arduino.cc/language-reference/
====
