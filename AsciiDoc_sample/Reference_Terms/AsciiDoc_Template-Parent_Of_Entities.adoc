...
:pygments-style: arduinogit push -u origin 
...
// use the syntax shown below. Please note that the file format is subsituted by {ext-relative} attribute.
// Please note that you always need to replace spaces that you might find in folder/file names with %20
* #LANGUAGE# link:AsciiDoc_Template-Single_Entity{ext-relative}[Single Entity]
* #LANGUAGE# link:../AsciiDoc_Dictionary/AsciiDoc_Template-Dictionary{ext-relative}[AsciiDoc Template Dictionary]
