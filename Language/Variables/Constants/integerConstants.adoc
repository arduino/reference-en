...
[float]
=== Description
Integer constants are numbers that are used directly in a sketch, like 123. By default, these numbers are treated as link:../../Data%20Types[int] but you can change this with the U and L modifiers (see below).
[%hardbreaks]
