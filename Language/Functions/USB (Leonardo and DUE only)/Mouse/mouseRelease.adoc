...
[float]
=== Description
Sends a message that a previously pressed button (invoked through link:mousePress{ext-relative}[Mouse.press()]) is released. Mouse.release() defaults to the left button.
[%hardbreaks]
