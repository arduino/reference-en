...
This function is part of the Stream class, and is called by any class that inherits from it (Wire, Serial, etc). See the #LANGUAGE# link:stream{ext-relative}[Stream class] main page for more information.
[%hardbreaks]
